...
const obfuscationOptions = {
    ...
    // 控制流混淆配置
    controlFlowFlattening: true, // false 启用控制流平坦化 高强度混淆：打乱代码执行顺序
    controlFlowFlatteningThreshold: 0.75, // 0.75 控制流平坦化应用比例 (0-1) 推荐值: 0.75（平衡安全与性能）
    deadCodeInjection: true, // true 注入无用代码 警告：显著增加代码体积（约30%）
    ...
    stringArrayThreshold: 0.8, // 0.8 启用字符串数组的阈值 (0-1)  🔧 调整：值越高处理的字符串越多
...
module.exports = { obfuscationOptions, tsObfuscatorConfig, WARNING_SIZE, MAX_SAFE_STRING_LENGTH };