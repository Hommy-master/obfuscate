...
class JsObfuscator {
    ...
    static _shouldObfuscateGlobal(name) {
        ...
        const reserved = new Set([
            ...
            'gtag',                // Google Analytics 4 主函数
            'ga',                  // Universal Analytics 函数
            'dataLayer',           // Google Tag Manager 数据层
            'GoogleAnalyticsObject', // GA对象名
            'gaplugins',           // GA插件
            'gaGlobal',           // GA全局对象
            '_gaq',               // 旧版GA队列
            '_gat',               // 旧版GA跟踪器
            'goog_report_conversion', // Google Ads转换跟踪

            // 其他第三方分析工具
            'fbq',                // Facebook Pixel
            '_fbq',               // Facebook Pixel备用
            'analytics',          // 通用分析对象
            'mixpanel',           // Mixpanel
            'amplitude',          // Amplitude
            '_hmt',               // 百度统计
            'yaCounter',          // Yandex Metrica
            '_paq'                // Matomo/Piwik
        ]);
